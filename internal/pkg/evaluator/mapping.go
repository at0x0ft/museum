...
func (self *mappingElement) visitKey(variables map[string]*yaml.Node) (*yaml.Node, error) {
...
func (self *mappingElement) visitValue(variables map[string]*yaml.Node) (*yaml.Node, error) {
